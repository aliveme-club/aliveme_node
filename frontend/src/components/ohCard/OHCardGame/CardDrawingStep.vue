<template>
  <div class="oh-card-step">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">{{ $t('components.ohCard.OHCardGame.CardDrawingStep.title') }}</h2>
    ...
    <div class="card-and-questions-container">
      ...
      <div class="card-column">
        ...
        <div v-if="!hasAnsweredQuestion" class="redraw-container mt-4">
          <button class="redraw-button" @click="onRedraw">
            <i class="fas fa-sync-alt mr-1"></i> {{ $t('components.ohCard.OHCardGame.CardDrawingStep.redrawButton') }}
          </button>
        </div>
      </div>
      ...
      <div v-if="!hasCompletedQuestions" class="questions-column">
        <h3 class="text-xl font-bold mb-4 text-gray-800">{{ $t('components.ohCard.OHCardGame.CardDrawingStep.promptTitle') }}</h3>
